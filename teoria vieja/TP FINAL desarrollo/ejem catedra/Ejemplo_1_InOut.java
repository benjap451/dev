 ...
 * algunas clases provistas por Java para el manejo de entrada/salida desde
 * archivos
 * de texto.
 *
 * En otras clases del mismo paquete veremos como generar archivos con
 * caracteristicas
...
public class Ejemplo_1_InOut {
    ...
    public static void main(String[] args) {
         ...
         * ejecutan por
         * consola, quiten de la ruta de los archivos el "src/ejemplo_InOut/" porque va
         * a fallar
